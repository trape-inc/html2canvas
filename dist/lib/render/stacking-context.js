...
var parseStackTree = function (parent, stackingContext, realStackingContext, listItems) {
    parent.container.elements.forEach(function (child) {
        var treatAsRealStackingContext = (0, bitwise_1.contains)(child.flags, 4 /* CREATES_REAL_STACKING_CONTEXT */);
        var createsStackingContext = (0, bitwise_1.contains)(child.flags, 2 /* CREATES_STACKING_CONTEXT */);
        var paintContainer = new ElementPaint(child, parent);
        if ((0, bitwise_1.contains)(child.styles.display, 2048 /* LIST_ITEM */)) {
            listItems.push(paintContainer);
        }
        var listOwnerItems = (0, bitwise_1.contains)(child.flags, 8 /* IS_LIST_OWNER */) ? [] : listItems;
        ...
        if ((0, bitwise_1.contains)(child.flags, 8 /* IS_LIST_OWNER */)) {
