...
describe('tokenizer', function () {
    describe('<ident>', function () {
        it('auto', function () { return (0, assert_1.deepEqual)(tokenize('auto'), [{ type: 20 /* IDENT_TOKEN */, value: 'auto' }]); });
        it('url', function () { return (0, assert_1.deepEqual)(tokenize('url'), [{ type: 20 /* IDENT_TOKEN */, value: 'url' }]); });
    ...
    describe('<url-token>', function () {
        it('url(test.jpg)', function () {
            return (0, assert_1.deepEqual)(tokenize('url(test.jpg)'), [{ type: 22 /* URL_TOKEN */, value: 'test.jpg' }]);
        });
        it('url("test.jpg")', function () {
            return (0, assert_1.deepEqual)(tokenize('url("test.jpg")'), [{ type: 22 /* URL_TOKEN */, value: 'test.jpg' }]);
        });
