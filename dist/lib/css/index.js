...
var CSSParsedDeclaration = /** @class */ (function () {
    ...
    CSSParsedDeclaration.prototype.isInlineLevel = function () {
        return ((0, bitwise_1.contains)(this.display, 4 /* INLINE */) ||
            (0, bitwise_1.contains)(this.display, 33554432 /* INLINE_BLOCK */) ||
            (0, bitwise_1.contains)(this.display, 268435456 /* INLINE_FLEX */) ||
            (0, bitwise_1.contains)(this.display, 536870912 /* INLINE_GRID */) ||
            (0, bitwise_1.contains)(this.display, 67108864 /* INLINE_LIST_ITEM */) ||
            (0, bitwise_1.contains)(this.display, 134217728 /* INLINE_TABLE */));
    };
